  ...
  // Examen
  {
    ...
    subSections: [
      ...
      },
      {
        ...
        grado: "9º Geup", 
        rango: "Principiante", 
        significado: `El color de la semilla, de la cual empieza a brotar las primeras 
        raíces. El estudiante comienza a practicar los ejercicios básicos del 
        HAP-KI-DO. El amarillo expresa precaución, desarrollo lento y 
        cuidadoso. El color del girasol que refleja la energía recibido del sol. `,
        sections: [
            { 
              title: "Figuras sin armas - Poomsaes", 
      ...
      },
      {
        ...
        grado: "8º Geup", 
        rango: "Principiante", 
        significado: `La semilla continúa su desarrollo profundizando sus raíces en él 
        conocimiento del HAP-KI-DO y esbozando el tallo de la proyección 
        de este en su vida. El estudiante empieza a refinar sus movimientos 
        rudimentarios. El naranja representa el deseo de mejorar, el 
        entusiasmo en la acción. `,
        sections: [
            { 
              title: "Figuras sin armas - Poomsaes", 
              content: [
      ...
      { 
        ...
        sections: [
            ...
            { 
              title: "Básicos con armas - Mugi Gibom", 
              content: [
                "35 básicos con Nunchakus",
                "10 básicos con Jang bong",
              ] 
            },
            { 
              title: "Llaves - Ho Sin Sul", 
...
// name"", color[#, #], grado"", rango"", significado"", sections[title"", content["", ""]]
              ...
              <>
                ...
                {subSection.sections.map((section, index) => (
                  <View key={index} style={{ marginVertical: 10 }}>
                    ...
                    {subSection.section.content.map((content, i) => (
                      <Text
                        key={i}
